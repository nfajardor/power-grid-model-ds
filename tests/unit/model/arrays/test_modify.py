...
class TestReorder:
    def test_reorder_by_id(self, fancy_test_array):
    ...
    def test_reorder_by_test_str(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_reorder_mismatched_length(self, fancy_test_array):
        with pytest.raises(ValueError):
            fancy_test_array.re_order([3, 1])


class TestUpdateById:
    def test_get_update_by_id(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_get_update_by_id_duplicate_id_input(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_update_by_id_multiple_columns(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_update_by_id_invalid_column(self, fancy_test_array):
        with pytest.raises(ValueError):
            fancy_test_array.update_by_id([1, 3], non_existing_column=123)

    def test_update_by_id_invalid_length(self, fancy_test_array):
        with pytest.raises(ValueError):
            fancy_test_array.update_by_id([1, 3], test_str=["e", "f", "g"])

    def test_update_by_id_invalid_id(self, fancy_test_array):
        with pytest.raises(ValueError):
            fancy_test_array.update_by_id([1, 4], test_str="e")

    def test_update_by_id_invalid_id_allow_missing(self, fancy_test_array):
    ...
    def test_update_by_id_non_existing_id(self, fancy_test_array):
        with pytest.raises(ValueError):
            fancy_test_array.update_by_id([1, 4], test_str="e")


class TestConcatenate:
    def test_concatenate_fancy_array(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_concatenate_to_empty_array(self, fancy_test_array):
    ...
    def test_concatenate_multiple_fancy_arrays(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_concatenate_ndarray(self, fancy_test_array):
        assert_array_equal(fancy_test_array.id, [1, 2, 3])
        assert_array_equal(fancy_test_array.test_str, ["a", "c", "d"])
    ...
    def test_concatenate_different_fancy_array(self, fancy_test_array):
        different_array = FancyNonIdArray.zeros(10)
        with pytest.raises(TypeError):
            fp.concatenate(fancy_test_array, different_array)

    def test_concatenate_different_ndarray(self, fancy_test_array):
        different_array = FancyNonIdArray.zeros(10)
        with pytest.raises(TypeError):
            fp.concatenate(fancy_test_array, different_array.data)

    def test_concatenate_different_fancy_array_same_dtype(self, fancy_test_array):
