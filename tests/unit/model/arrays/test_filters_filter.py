...
def test_filter_by_id_kwarg(fancy_test_array):
...
def test_filter_by_id_arg(fancy_test_array):
...
def test_filter_by_int(fancy_test_array):
    array = fancy_test_array.filter(test_int=4)
    assert array.size == 1
    assert array.test_int == 4


def test_filter_by_float(fancy_test_array):
...
def test_filter_arg_by_set_input(fancy_test_array):
